...
class TreeNode37(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self._ = elements[2]
        self.modifier_def_body = elements[3]
...
class Grammar(object):
    ...
    def _read_bag_info_item(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['bag_info_item'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        ...
        if address0 is FAILURE:
            ...
            if elements1 is None:
                ...
                address0 = TreeNode5(self._input[index4:self._offset], index4, elements1)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
                ...
                if address0 is FAILURE:
                    ...
                    if address0 is FAILURE:
                        self._offset = index1
        self._cache['bag_info_item'][index0] = (address0, self._offset)
        return address0

    def _read_bag_info(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['bag_info'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if address1 is not FAILURE:
            ...
            if address2 is not FAILURE:
                elements0.append(address2)
                address3 = FAILURE
                address3 = self._read_bag_info_item()
                if address3 is not FAILURE:
                    elements0.append(address3)
                    address4 = FAILURE
                    address4 = self._read__ws()
        ...
        if elements0 is None:
            ...
            address0 = self._actions.bag_info(self._input, index1, self._offset, elements0)
            self._offset = self._offset
        self._cache['bag_info'][index0] = (address0, self._offset)
        return address0

    def _read_bag_def(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['bag_def'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1 = self._offset
        ...
        if address0 is FAILURE:
            ...
            if elements3 is None:
                ...
                address0 = TreeNode9(self._input[index5:self._offset], index5, elements3)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
                ...
                if elements4 is None:
                    ...
                    address0 = TreeNode10(self._input[index6:self._offset], index6, elements4)
                    self._offset = self._offset
                if address0 is FAILURE:
                    self._offset = index1
        self._cache['bag_def'][index0] = (address0, self._offset)
        return address0
    ...
    def _read_modifier_def_body(self):
        address0, index0 = FAILURE, self._offset
        cached = self._cache['modifier_def_body'].get(index0)
        if cached:
            self._offset = cached[1]
            return cached[0]
        index1, elements0 = self._offset, []
        ...
        if elements0 is None:
            ...
            self._offset = self._offset
        self._cache['modifier_def_body'][index0] = (address0, self._offset)
        return address0
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if address4 is not FAILURE:
                        elements0.append(address4)
                        address5 = FAILURE
                        address5 = self._read_modifier_def_body()
                        if address5 is not FAILURE:
                            elements0.append(address5)
                        else:
                            elements0 = None
    ...
    def _read_basic_load_list(self):
        ...
        while address2 is not FAILURE:
            ...
            if elements2 is None:
                ...
                address2 = TreeNode41(self._input[index3:self._offset], index3, elements2)
                self._offset = self._offset
            if address2 is not FAILURE:
                elements1.append(address2)
                remaining0 -= 1
    ...
    def _read_access_load_list(self):
        ...
        while address2 is not FAILURE:
            ...
            if elements2 is None:
                ...
                address2 = TreeNode42(self._input[index3:self._offset], index3, elements2)
                self._offset = self._offset
            if address2 is not FAILURE:
                elements1.append(address2)
                remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            if address6 is not FAILURE:
                ...
                if elements3 is None:
                    ...
                    address7 = TreeNode56(self._input[index6:self._offset], index6, elements3)
                    self._offset = self._offset
                if address7 is FAILURE:
                    self._offset = index5
                        ...
                        if address9 is not FAILURE:
                            ...
                            if address10 is not FAILURE:
                                ...
                                if elements3 is None:
                                    ...
                                    address12 = TreeNode64(self._input[index6:self._offset], index6, elements3)
                                    self._offset = self._offset
                    ...
                    if address0 is FAILURE:
                        ...
                        if address0 is FAILURE:
                            ...
                            if elements2 is None:
                                ...
                                address0 = TreeNode67(self._input[index4:self._offset], index4, elements2)
                                self._offset = self._offset
                            if address0 is FAILURE:
                                self._offset = index1
                                index5, elements3 = self._offset, []
                                ...
                                if address10 is not FAILURE:
                                    ...
                                    if address11 is not FAILURE:
                                        ...
                                        if address12 is not FAILURE:
                                            ...
                                            address13 = FAILURE
                                            address13 = self._read_block_stmt()
                                            if address13 is not FAILURE:
                                                elements3.append(address13)
                                                address14 = FAILURE
                                                address14 = self._read__ws()
                                                    ...
                                                    if address29 is not FAILURE:
                                                        ...
                                                        while address31 is not FAILURE:
                                                            ...
                                                            if elements8 is None:
                                                                ...
                                                                address31 = TreeNode72(self._input[index13:self._offset], index13, elements8)
                                                                self._offset = self._offset
                                                        ...
                                                        if address30 is not FAILURE:
                                                            ...
                                                            if elements9 is None:
                                                                ...
                                                                address34 = TreeNode73(self._input[index15:self._offset], index15, elements9)
                                                                self._offset = self._offset
                                                                                        ...
                                                                                        if address59 is not FAILURE:
                                                                                            ...
                                                                                            while address61 is not FAILURE:
                                                                                                ...
                                                                                                if elements13 is None:
                                                                                                    ...
                                                                                                    address61 = TreeNode76(self._input[index21:self._offset], index21, elements13)
                                                                                                    self._offset = self._offset
                                                                ...
                                                                if address0 is FAILURE:
                                                                    ...
                                                                    if address0 is FAILURE:
                                                                        ...
                                                                        if elements17 is None:
                                                                            ...
                                                                            address0 = TreeNode79(self._input[index26:self._offset], index26, elements17)
                                                                            self._offset = self._offset
                                                                        if address0 is FAILURE:
                                                                            self._offset = index1
