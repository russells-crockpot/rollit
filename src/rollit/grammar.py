...
class TreeNode11(TreeNode):
    def __init__(self, text, offset, elements):
        ...
        self._ws = elements[0]
        self._ = elements[5]
        self.special_accessor = elements[3]
...
class Grammar(object):
    ...
    def _read_new_bag(self):
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode5(self._input[index4:self._offset], index4, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
                ...
                if address3 is not FAILURE:
                    ...
                    if address9 is not FAILURE:
                        ...
                        address10 = FAILURE
                        address10 = self._read_stmt_or_expr()
        ...
        if address0 is FAILURE:
            ...
            if elements3 is None:
                ...
                address0 = self._actions.new_bag(self._input, index5, self._offset, elements3)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
                ...
                if elements4 is None:
                    ...
                    address0 = self._actions.new_bag(self._input, index6, self._offset, elements4)
                    self._offset = self._offset
                if address0 is FAILURE:
                    self._offset = index1
    ...
    def _read_accessor(self):
        ...
        if address0 is FAILURE:
                    ...
                    if address8 is not FAILURE:
                        ...
                        if address9 is not FAILURE:
                            ...
                            if address10 is not FAILURE:
                                ...
                                address11 = FAILURE
                                address11 = self._read_special_accessor()
                                if address11 is not FAILURE:
            ...
            if elements1 is None:
                ...
                address0 = TreeNode11(self._input[index3:self._offset], index3, elements1)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
                index4, elements2 = self._offset, []
                address15 = FAILURE
                address15 = self._read__ws()
                if address15 is not FAILURE:
                        ...
                        if address17 is not FAILURE:
                            ...
                            if address18 is not FAILURE:
                                ...
                                if address19 is not FAILURE:
                                    ...
                                    address20 = FAILURE
                                    address20 = self._read_special_entry()
                                    if address20 is not FAILURE:
                ...
                if address0 is FAILURE:
                    ...
                    if address24 is not FAILURE:
                        ...
                        if chunk7 == '.':
                            address25 = TreeNode(self._input[self._offset:self._offset + 1], self._offset, [])
                            self._offset = self._offset + 1
                        else:
                            address25 = FAILURE
                            if self._offset > self._failure:
                            ...
                            if address26 is not FAILURE:
                                ...
                                if address27 is not FAILURE:
                                    ...
                                    if address28 is not FAILURE:
                                        elements3.append(address28)
                                        address29 = FAILURE
                                        address29 = self._read_expression()
                                        if address29 is not FAILURE:
                                            elements3.append(address29)
                                            address30 = FAILURE
                                            address30 = self._read__()
                                            if address30 is not FAILURE:
                                                elements3.append(address30)
                                                address31 = FAILURE
                                                chunk9, max9 = None, self._offset + 1
                                                if max9 <= self._input_size:
                                                    chunk9 = self._input[self._offset:max9]
                                                if chunk9 == '>':
                                                    address31 = TreeNode(self._input[self._offset:self._offset + 1], self._offset, [])
                                                    self._offset = self._offset + 1
                                                else:
                                                    address31 = FAILURE
                                                    if self._offset > self._failure:
                    ...
                    if elements3 is None:
                        ...
                        address0 = self._actions.raw_accessor(self._input, index5, self._offset, elements3)
                        self._offset = self._offset
                    if address0 is FAILURE:
                        self._offset = index1
                        index6, elements4 = self._offset, []
                        address33 = FAILURE
                        address33 = self._read__ws()
                        if address33 is not FAILURE:
                            ...
                            if address34 is not FAILURE:
                                ...
                                if address35 is not FAILURE:
                                    elements4.append(address35)
                                    address36 = FAILURE
                                    address36 = self._read_reduce()
                                    if address36 is not FAILURE:
                                        elements4.append(address36)
                                        address37 = FAILURE
                                        address37 = self._read__()
                                        if address37 is not FAILURE:
                                            elements4.append(address37)
                                        else:
                                            elements4 = None
                                            self._offset = index6
                                    else:
                        ...
                        if elements4 is None:
                            ...
                            address0 = TreeNode14(self._input[index6:self._offset], index6, elements4)
                            self._offset = self._offset
                        if address0 is FAILURE:
                            self._offset = index1
        ...
        if address0 is FAILURE:
            ...
            if address5 is not FAILURE:
                ...
                if address6 is not FAILURE:
                    elements2.append(address6)
                    address7 = FAILURE
                    address7 = self._read_special_entry()
                    if address7 is not FAILURE:
                        elements2.append(address7)
                        address8 = FAILURE
                        address8 = self._read__()
            ...
            if elements2 is None:
                ...
                address0 = TreeNode17(self._input[index4:self._offset], index4, elements2)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
                address0 = self._read_name()
                            ...
                            if address0 is FAILURE:
                                ...
                                if address1 is not FAILURE:
                                    ...
                                    if elements1 is None:
                                        ...
                                        address2 = TreeNode18(self._input[index4:self._offset], index4, elements1)
                                        self._offset = self._offset
                                    self._offset = index3
                                    if address2 is FAILURE:
                                        address2 = TreeNode(self._input[self._offset:self._offset], self._offset, [])
                                ...
                                if address0 is FAILURE:
                                    ...
                                    if address5 is not FAILURE:
                                        ...
                                        if elements3 is None:
                                            ...
                                            address6 = TreeNode19(self._input[index7:self._offset], index7, elements3)
                                            self._offset = self._offset
                                        self._offset = index6
            ...
            if address2 is not FAILURE:
                ...
                while address4 is not FAILURE:
                    ...
                    if elements2 is None:
                        ...
                        address4 = TreeNode33(self._input[index3:self._offset], index3, elements2)
                        self._offset = self._offset
                    if address4 is not FAILURE:
                        elements1.append(address4)
                        remaining0 -= 1
    ...
    def _read_modifier_params(self):
        ...
        while address2 is not FAILURE:
            ...
            if elements2 is None:
                ...
                address2 = TreeNode34(self._input[index3:self._offset], index3, elements2)
                self._offset = self._offset
            if address2 is not FAILURE:
                elements1.append(address2)
                remaining0 -= 1
    ...
    def _read_normal_modifier_body(self):
                    ...
                    if address4 is not FAILURE:
                        ...
                        if address5 is not FAILURE:
                            ...
                            if address6 is not FAILURE:
                                elements0.append(address6)
                                address7 = FAILURE
                                address7 = self._read_block_stmt()
                                if address7 is not FAILURE:
                                    elements0.append(address7)
                                    address8 = FAILURE
                                    address8 = self._read__()
        ...
        if elements0 is None:
            ...
            address0 = self._actions.normal_modifier_body(self._input, index2, self._offset, elements0)
            self._offset = self._offset
        if address0 is FAILURE:
            self._offset = index1
            index4, elements1 = self._offset, []
            address11 = FAILURE
            address11 = self._read_modifier_params()
            if address11 is not FAILURE:
                elements1.append(address11)
                address12 = FAILURE
                address12 = self._read__()
            ...
            if elements1 is None:
                ...
                address0 = self._actions.normal_modifier_body(self._input, index4, self._offset, elements1)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
    ...
    def _read_modifier_def_target(self):
        ...
        if address0 is FAILURE:
            ...
            if elements0 is None:
                ...
                address0 = TreeNode38(self._input[index2:self._offset], index2, elements0)
                self._offset = self._offset
            if address0 is FAILURE:
                self._offset = index1
                chunk2, max2 = None, self._offset + 1
            ...
            if address2 is not FAILURE:
                ...
                if address3 is not FAILURE:
                    ...
                    if address4 is not FAILURE:
                        ...
                        address5 = FAILURE
                        index2 = self._offset
                        address5 = self._read_small_modifier_body()
                        if address5 is FAILURE:
                            self._offset = index2
                            address5 = self._read_normal_modifier_body()
                            if address5 is FAILURE:
                                self._offset = index2
                        if address5 is not FAILURE:
                            elements0.append(address5)
    ...
    def _read_basic_load_list(self):
        ...
        while address2 is not FAILURE:
            ...
            if elements2 is None:
                ...
                address2 = TreeNode43(self._input[index3:self._offset], index3, elements2)
                self._offset = self._offset
            if address2 is not FAILURE:
                elements1.append(address2)
                remaining0 -= 1
    ...
    def _read_access_load_list(self):
        ...
        while address2 is not FAILURE:
            ...
            if elements2 is None:
                ...
                address2 = TreeNode44(self._input[index3:self._offset], index3, elements2)
                self._offset = self._offset
            if address2 is not FAILURE:
                elements1.append(address2)
                remaining0 -= 1
    ...
    def _read_block_stmt(self):
        ...
        while address2 is not FAILURE:
            ...
            if elements2 is None:
                ...
                address2 = TreeNode57(self._input[index3:self._offset], index3, elements2)
                self._offset = self._offset
            if address2 is not FAILURE:
                elements1.append(address2)
                remaining0 -= 1
        ...
        if address1 is not FAILURE:
            ...
            if address6 is not FAILURE:
                ...
                if elements3 is None:
                    ...
                    address7 = TreeNode58(self._input[index6:self._offset], index6, elements3)
                    self._offset = self._offset
                if address7 is FAILURE:
                    self._offset = index5
    ...
    def _read_but_if_stmt(self):
        ...
        if elements0 is None:
            ...
            address0 = TreeNode61(self._input[index2:self._offset], index2, elements0)
            self._offset = self._offset
        if address0 is FAILURE:
            self._offset = index1
                        ...
                        if address9 is not FAILURE:
                            ...
                            if address10 is not FAILURE:
                                ...
                                if elements3 is None:
                                    ...
                                    address12 = TreeNode66(self._input[index6:self._offset], index6, elements3)
                                    self._offset = self._offset
                    ...
                    if address0 is FAILURE:
                        ...
                        if address0 is FAILURE:
                            ...
                            if elements2 is None:
                                ...
                                address0 = TreeNode69(self._input[index4:self._offset], index4, elements2)
                                self._offset = self._offset
                            if address0 is FAILURE:
                                self._offset = index1
                                index5, elements3 = self._offset, []
                                    ...
                                    if address0 is FAILURE:
                                        ...
                                        if address20 is not FAILURE:
                                            ...
                                            if address21 is FAILURE:
                                                address21 = TreeNode(self._input[self._offset:self._offset], self._offset, [])
                                                self._offset = self._offset
                                            else:
                                                address21 = FAILURE
                                            if address21 is not FAILURE:
                                                ...
                                                if address22 is not FAILURE:
                                                    elements5.append(address22)
                                                    address23 = FAILURE
                                                    address23 = self._read_access()
                                                    if address23 is not FAILURE:
                                        ...
                                        if address0 is FAILURE:
                                            ...
                                            if address0 is FAILURE:
                                                ...
                                                if address0 is FAILURE:
                                                    ...
                                                    address27 = FAILURE
                                                    address27 = self._read_if_then()
                                                    if address27 is not FAILURE:
                                                        elements6.append(address27)
                                                        address28 = FAILURE
                                                        remaining0, index10, elements7, address29 = 0, self._offset, [], True
                                                        while address29 is not FAILURE:
                                                            index11, elements8 = self._offset, []
                                                            address30 = FAILURE
                                                            address30 = self._read__ws()
                                                            if address30 is not FAILURE:
                                                                elements8.append(address30)
                                                                address31 = FAILURE
                                                                address31 = self._read_unless()
                                                                if address31 is not FAILURE:
                                                                    elements8.append(address31)
                                                                else:
                                                                    elements8 = None
                                                            ...
                                                            if elements8 is None:
                                                                ...
                                                                address29 = TreeNode74(self._input[index11:self._offset], index11, elements8)
                                                                self._offset = self._offset
                                                            if address29 is not FAILURE:
                                                                elements7.append(address29)
                                                                remaining0 -= 1
                                                        if remaining0 <= 0:
                                                            address28 = TreeNode(self._input[index10:self._offset], index10, elements7)
                                                            self._offset = self._offset
                                                        else:
                                                            address28 = FAILURE
                                                        if address28 is not FAILURE:
                                                            elements6.append(address28)
                                                            address32 = FAILURE
                                                            index12 = self._offset
                                                            index13, elements9 = self._offset, []
                                                            address33 = FAILURE
                                                            address33 = self._read__ws()
                                                            if address33 is not FAILURE:
                                                                elements9.append(address33)
                                                                address34 = FAILURE
                                                                address34 = self._read_otherwise()
                                                                if address34 is not FAILURE:
                                                            ...
                                                            if elements9 is None:
                                                                ...
                                                                address32 = TreeNode75(self._input[index13:self._offset], index13, elements9)
                                                                self._offset = self._offset
                                                            if address32 is FAILURE:
                                                                address32 = TreeNode(self._input[index12:index12], index12, [])
                                                                self._offset = index12
                                                            if address32 is not FAILURE:
                                                                elements6.append(address32)
                                                            else:
                                                                elements6 = None
                                                                self._offset = index9
                                                        else:
                                                    ...
                                                    if elements6 is None:
                                                        ...
                                                        address0 = self._actions.if_stmt(self._input, index9, self._offset, elements6)
                                                        self._offset = self._offset
                                                    if address0 is FAILURE:
                                                        self._offset = index1
                                                        ...
                                                        if max11 <= self._input_size:
                                                            chunk11 = self._input[self._offset:max11]
                                                        if chunk11 == 'for':
                                                            address35 = TreeNode(self._input[self._offset:self._offset + 3], self._offset, [])
                                                            self._offset = self._offset + 3
                                                        else:
                                                            address35 = FAILURE
                                                            if self._offset > self._failure:
                                                                ...
                                                                if address37 is not FAILURE:
                                                                    ...
                                                                    if address38 is not FAILURE:
                                                                        ...
                                                                        if address39 is FAILURE:
                                                                            address39 = TreeNode(self._input[index15:index15], index15, [])
                                                                        ...
                                                                        if address39 is not FAILURE:
                                                                            ...
                                                                            if address40 is not FAILURE:
                                                                                ...
                                                                                address41 = FAILURE
                                                                                address41 = self._read_basic_name()
                                                                                if address41 is not FAILURE:
                                                                                    ...
                                                                                    if address42 is not FAILURE:
                                                                                        ...
                                                                                        if chunk13 == 'that':
                                                                                            address43 = TreeNode(self._input[self._offset:self._offset + 4], self._offset, [])
                                                                                            self._offset = self._offset + 4
                                                                                        else:
                                                                                            address43 = FAILURE
                                                                                            if self._offset > self._failure:
                                                                                                    ...
                                                                                                    if address46 is not FAILURE:
                                                                                                        ...
                                                                                                        if address47 is not FAILURE:
                                                                                                            ...
                                                                                                            if address48 is not FAILURE:
                                                                                                                ...
                                                                                                                address49 = FAILURE
                                                                                                                address49 = self._read_loop_body()
                                                                                                                if address49 is not FAILURE:
                                                                                                                    elements10.append(address49)
                                                                                                                else:
                                                                                                                    elements10 = None
                                                        ...
                                                        if elements10 is None:
                                                            ...
                                                            address0 = self._actions.for_every(self._input, index14, self._offset, elements10)
                                                            self._offset = self._offset
                                                        if address0 is FAILURE:
                                                            self._offset = index1
                                                            index16, elements11 = self._offset, []
                                                            address50 = FAILURE
                                                            chunk15, max15 = None, self._offset + 5
                                                            if max15 <= self._input_size:
                                                                chunk15 = self._input[self._offset:max15]
                                                            if chunk15 == 'until':
                                                                address50 = TreeNode(self._input[self._offset:self._offset + 5], self._offset, [])
                                                                self._offset = self._offset + 5
                                                            else:
                                                                address50 = FAILURE
                                                                if self._offset > self._failure:
                                                            ...
                                                            if address50 is not FAILURE:
                                                                ...
                                                                if address51 is not FAILURE:
                                                                    ...
                                                                    address52 = self._read_loop_name()
                                                                    if address52 is FAILURE:
                                                                        address52 = TreeNode(self._input[index17:index17], index17, [])
                                                                        ...
                                                                        if address53 is not FAILURE:
                                                                            ...
                                                                            if address54 is not FAILURE:
                                                                                ...
                                                                                if address55 is not FAILURE:
                                                                                    ...
                                                                                    address56 = FAILURE
                                                                                    address56 = self._read_loop_body()
                                                                                    if address56 is not FAILURE:
                                                                                        elements11.append(address56)
                                                                                        address57 = FAILURE
                                                                                        address57 = self._read__ws()
                                                                                        if address57 is not FAILURE:
                                                                                            elements11.append(address57)
                                                                                            address58 = FAILURE
                                                                                            remaining1, index18, elements12, address59 = 0, self._offset, [], True
                                                                                            while address59 is not FAILURE:
                                                                                                index19, elements13 = self._offset, []
                                                                                                address60 = FAILURE
                                                                                                address60 = self._read_except_when()
                                                                                                if address60 is not FAILURE:
                                                                                                    elements13.append(address60)
                                                                                                    address61 = FAILURE
                                                                                                    address61 = self._read__ws()
                                                                                                ...
                                                                                                if elements13 is None:
                                                                                                    ...
                                                                                                    address59 = TreeNode78(self._input[index19:self._offset], index19, elements13)
                                                                                                    self._offset = self._offset
                                                                                                if address59 is not FAILURE:
                                                                                                    elements12.append(address59)
                                                                                                    remaining1 -= 1
                                                                                            if remaining1 <= 0:
                                                                                                address58 = TreeNode(self._input[index18:self._offset], index18, elements12)
                                                                                                self._offset = self._offset
                                                                                            else:
                                                                                                address58 = FAILURE
                                                                                            if address58 is not FAILURE:
                                                                                                ...
                                                                                                address62 = self._read_otherwise()
                                                                                                if address62 is FAILURE:
                                                                                                    address62 = TreeNode(self._input[index20:index20], index20, [])
                                                                                                    self._offset = index20
                                                                                                if address62 is not FAILURE:
                                                                                                    elements11.append(address62)
                                                                                                else:
                                                                                                    elements11 = None
                                                            ...
                                                            if elements11 is None:
                                                                ...
                                                                address0 = self._actions.until_do(self._input, index16, self._offset, elements11)
                                                                self._offset = self._offset
                                                            if address0 is FAILURE:
                                                                self._offset = index1
                                                                index21, elements14 = self._offset, []
                                                                address63 = FAILURE
                                                                address63 = self._read_access()
                                                                    ...
                                                                    if address64 is not FAILURE:
                                                                        ...
                                                                        if address65 is not FAILURE:
                                                                            ...
                                                                            if address66 is not FAILURE:
                                                                                ...
                                                                                address67 = FAILURE
                                                                                address67 = self._read_modifier_tail()
                                                                                if address67 is not FAILURE:
                                                                                    elements14.append(address67)
                                                                                    address68 = FAILURE
                                                                                    remaining2, index22, elements15, address69 = 0, self._offset, [], True
                                                                                    while address69 is not FAILURE:
                                                                                        address69 = self._read_modifier_call()
                                                                                        if address69 is not FAILURE:
                                                                                            elements15.append(address69)
                                                                                            remaining2 -= 1
                                                                                    if remaining2 <= 0:
                                                                                        address68 = TreeNode(self._input[index22:self._offset], index22, elements15)
                                                                                        self._offset = self._offset
                                                                                    else:
                                                                                        address68 = FAILURE
                                                                ...
                                                                if address0 is FAILURE:
                                                                    ...
                                                                    if address0 is FAILURE:
                                                                        ...
                                                                        address75 = FAILURE
                                                                        address75 = self._read_expression()
                                                                        if address75 is not FAILURE:
                                                                            elements17.append(address75)
                                                                            address76 = FAILURE
                                                                            address76 = self._read__()
                                                                            if address76 is not FAILURE:
                                                                                elements17.append(address76)
                                                                                address77 = FAILURE
                                                                                address77 = self._read_eos()
                                                                        ...
                                                                        if elements17 is None:
                                                                            ...
                                                                            address0 = TreeNode81(self._input[index24:self._offset], index24, elements17)
                                                                            self._offset = self._offset
                                                                        if address0 is FAILURE:
                                                                            self._offset = index1
