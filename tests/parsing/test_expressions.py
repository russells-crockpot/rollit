...
test_modify = create_scripttest_func('modify')
test_rolls = create_scripttest_func('reduce')
test_rolls = create_scripttest_func('enlarge')
# test_length = create_scripttest_func('length')
